  ...
  <div class="dashboard-container">
    <div class="app-container">
      <el-card>
        ...
        <div class="fr">
            <router-link :to="{'path':'/employees/import/',query: {name: '学生信息'}}" class="el-button el-button--primary el-button--mini" title="导入">导入</router-link>
      ...
      <el-card shadow="never" class="boxMar">
        <el-table :data="dataList" fit style="width: 100%;" border>
          ...
          <el-table-column sortable prop="workNumber" label="学号" width="120"></el-table-column>
          <el-table-column sortable prop="formOfEmployment" label="是否已入实验室" width="200"></el-table-column>
          <el-table-column sortable prop="departmentName" label="实验室" width="200"></el-table-column>
